...
public partial class Logged_Reports_TarjetaEmpleado : System.Web.UI.Page
{
    ...
    {
        List<CorporateCardReportDTO> gastos = new List<CorporateCardReportDTO>();
        using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["PortalConnection"].ToString()))
        {
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "SpReportTarjetaEmpleado";
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        try
        {
            List<CorporateCardReportDTO> list_dto = new List<CorporateCardReportDTO>();
            ...
            report_document.Load(Path.Combine(Server.MapPath("~/Reports"), "TarjetaEmpleadoReport.rpt"));
            report_document.SetDataSource(list_dto);
            report_document.SetParameterValue("titulo", "Reporte Gasto Tarjeta Corporativa");
